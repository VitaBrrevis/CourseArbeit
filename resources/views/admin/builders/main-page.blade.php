...
<body>
<button id="save-button" class="btn btn-success save-btn">Save</button>
...
`,
        ...
        view: {
            ...
            render() {
                this.el.innerHTML = `
                    <div class="alert alert-info">Products list (preview)</div>
                `;
                this.updateStyle();
                return this;
            },
